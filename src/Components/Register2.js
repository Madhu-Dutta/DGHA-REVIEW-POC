...
export default class Register2 extends Component {
    ...
    handleInputChange = (e) => {
        ...
        if(inputName === 'firstName'){
           var fNamePattern=/^([a-zA-Z]{2,30})$/;
           if(!fNamePattern.test(inputValue)){
               this.setState({firstName: "FirstName is not valid"});
           }
        }
        if(inputName === 'lastName'){
            var lNamePattern=/^([a-zA-Z]{2,30})$/;
            if(!lNamePattern.test(inputValue)){
                this.setState({lastName: "LastName is not valid"});
            }
         }
        if(inputName === 'email'){
                    ...
                    <Form name="form" onSubmit={this.register} noValidate>
                        ...
                        <FormGroup>
                            ...
                            <FormGroup>                                
                                ...
                                noValidate />
                                   <span className='errorMsg'>{this.state.firstName}</span>  
                                <FormText color="muted">
                                    0-10 max characters
                            </FormText>
                            ...
                            <FormGroup>
                                ...
                                noValidate />
                                   <span className='errorMsg'>{this.state.lastName}</span>  
                                <FormText color="muted">
                                    0-10 max characters
                            </FormText>
                            </FormGroup>
                            ...
                            <FormGroup>
                                ...
                                <Input type="email"                                    
                                    ...
                                    noValidate />                              
                                    <span className='errorMsg'>{this.state.email}</span>                             
                            </FormGroup>
